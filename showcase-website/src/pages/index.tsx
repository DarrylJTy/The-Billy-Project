					...
					<div className="d-flex flex-row first-content-block">
						<div className="col-sm text-area">
							<div className="text-content">
								<h2>Quality Tiles for Every Space</h2>
								<br />
								<p>
									Explore a wide range of tiles that blend
									style and durability, perfect for any space
						...
						<img
							src="../index-picture.png"
							className="img-fluid col-sm px-0 img-area image1"
						/>
					</div>
					...
					<div className="d-flex flex-row second-content-block">
						<div className="col-sm branches-area">
							<div className="branches-content">
								<p>
									...
									<br />
									Check out our branches located in Laguna and
									Metro Manila.
								</p>
								<Link
									to="/branches"
									className="btn btn-outline-dark button2"
								>
									See Our Branches
								</Link>
							</div>
						...
						<div className="col-sm review-area">
							<div className="review-content">
								<p>
									<h2>Shopped Recently?</h2>
									<br />
									Let us know how well we served you by rating
